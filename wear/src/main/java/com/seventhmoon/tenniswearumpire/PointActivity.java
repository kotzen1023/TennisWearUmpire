...
import static com.seventhmoon.tenniswearumpire.Data.Constants.VOICE_TYPE.*;
...
public class PointActivity extends WearableActivity {
    ...
    private static void checkGames(State new_state) {
        ...
        if (tiebreak.equals("0") || tiebreak.equals("2")) { //use tibreak or super tiebreak
            ...
            if (games.equals("0")) { //6 game in a set
                ...
                if (is_In_SuperTiebreak) {
                    ...
                    if (new_state.getSet_game_up(current_set) == 1 &&
                            new_state.getSet_game_down(current_set) == 0) { // 1:0 => oppt win this set
                        //set sets win
                        setsWinUp++;
    ...
    private Runnable updateTimer = new Runnable() {
        public void run() {
            ...
            if (!stack.isEmpty()) {
                ...
                message = "init;"+set+";"+games+";"+tiebreak+";"+deuce+";"+serve+";"+startTime;
            }
